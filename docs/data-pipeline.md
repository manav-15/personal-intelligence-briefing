...
| UX-06     | Chat phase           | Planned         | Responsive application shell                                    | The shell header, six-link navigation, and footer still render above and below every screen and consume about 105px above the chat at 390px, wrapping to two navigation rows at 320px. Increment 5.2 deliberately left them unchanged. A shell pass must keep Today, Archive, Topics, Memory & settings, and the Content lab usable at 320px and re-verify all six routes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| UX-07     | Chat phase           | Planned         | Real-device verification of mobile chat                         | Increment 5.2 was verified only in emulated Chromium, and the detached-conversation, no-edition, and load-failure screens are unreachable in the current local state. Keyboard opening, rotation, scroll-into-view on focus, and drawer focus behaviour on iOS Safari and Android Chrome need a device or device cloud, plus a fixture that can produce those screens                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| UX-08     | Chat phase           | Planned         | Composer reachability and follow behaviour                      | Increment 2 of the mobile plan: a viewport-fitting chat layout with a composer that starts at one or two lines and grows to a bounded height, on-screen-keyboard and safe-area handling (`viewport-fit=cover`, `100dvh`, `interactive-widget=resizes-content`), and follow-only-when-near-bottom with a Jump to latest control. The follow decision belongs in a pure module, because `vitest` runs with `environment: 'node'` and no component test setup exists                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| UX-09     | Chat phase           | Planned         | Touch and reading polish for chat                               | Increment 3 of the mobile plan: newline entry on coarse pointers without accidental submission, desktop shortcut hints hidden on touch screens, at least 44px touch targets for the remaining controls, and a guard that keeps input text at or above 16px so iOS Safari does not zoom                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
