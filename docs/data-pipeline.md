...
| DEPLOY-01 | Deployment phase     | Partial         | Private hosted SearXNG                                         | Container class, binding and pinned image configuration restored in the working tree; local image build passed. Remaining: configure SEARXNG_SECRET through Cloudflare secrets and deploy only after separate review, then verify cold startup and hosted engine coverage with DISC-10. No public SearXNG route is permitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
